...
gg_main_map <- basemap_main$map +
  geom_sf(data = bird_df_sf_3857[2:nrow(bird_df_sf_3857),], shape = 21, fill = "magenta", col = "white", size = 2, stroke = 0.5) +
  theme_void()
gg_main_map
...
ggsave(
  filename = paste0("all_resighting_obs_static_inset_map_", today_date, "_", wash_obs_only, ".png"),
  device="png",
  path = outputwd,
  # height = 10,
  # width = 12,
...
ggsave(
  gg_main_map,
  filename = paste0("all_resighting_obs_static_main_map_", today_date, "_", wash_obs_only, ".png"),
  device="png",
  path = outputwd,
  # height = 10,
  # width = 12,
